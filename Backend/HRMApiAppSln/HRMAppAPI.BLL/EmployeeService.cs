    ...
    {    
        public async Task<EmployeeDTO?> GetByIdAsync(int idClient, int id, CancellationToken cancellationToken)
        {
            ...
            var employeeDto = new EmployeeDTO
            {
                ...
                HasOvertime = (bool)employee.HasOvertime.GetValueOrDefault(),
                HasAttendenceBonus = (bool)employee.HasAttendenceBonus.GetValueOrDefault(),
        ...
        public async Task<List<EmployeeDTO>> GetAllAsync(int idClient, CancellationToken cancellationToken)
        {
                ...
                .Select(e => new EmployeeDTO
            {
                    ...
                    ContactNo = e.ContactNo,
                    HasOvertime = (bool)e.HasOvertime.GetValueOrDefault(),
                    HasAttendenceBonus = (bool)e.HasAttendenceBonus.GetValueOrDefault(),
